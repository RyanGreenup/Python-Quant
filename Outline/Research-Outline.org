...
6. Discuss isomorphisms for recursive Relations
7. Jump to Lorenz Attractor
8. Now Talk about Morphogenesis
9. Fractals
...
11. Things I'd like to Try (in order to see different ways to approach Problems)
