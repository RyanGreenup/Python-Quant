...
function scaleAndMeasure(min, max, n)
    ...
    ## List comprehension tends to be faster than loops and mapping
    ## I had really high memory usage with list comprehension.
    ## `pmap` is better for expensive jobs, for loops are better for easier jobs. 
